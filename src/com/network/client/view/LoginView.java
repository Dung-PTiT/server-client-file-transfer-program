...
public class LoginView extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        LoginFormData loginFormData = new LoginFormData(jTextField3.getText(), String.copyValueOf(jPasswordField1.getPassword()));
        clientController.host = jTextField1.getText();
        clientController.port = Integer.parseInt(jTextField2.getText());
        clientController.login(loginFormData);
